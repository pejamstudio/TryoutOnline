    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{url('editguru', $guru->id)}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="notelepon" placeholder="Masukkan nomor telepon" name="notelp" required="" value="{{$guru1->telp}}" pattern="[0-9]{0-2}">
                                    </div>
