        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{url('master/editsoal', $soal->id)}}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="pila" id="pila">{{$soal->jawab_a}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="pilb">Pilihan B</label>
                                <textarea class="form-control" name="pilb" id="pilb">{{$soal->jawab_b}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="pilc">Pilihan C</label>
                                <textarea class="form-control" name="pilc" id="pilc">{{$soal->jawab_c}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="pild">Pilihan D</label>
                                <textarea class="form-control" name="pild" id="pild">{{$soal->jawab_d}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="pile">Pilihan E</label>
                                <textarea class="form-control" name="pile" id="pile">{{$soal->jawab_e}}</textarea>
                            </div>
                            ...
                            <a class="btn btn-danger mr-1" href="{{url('master/mapel/datasoal', $soal->id_mapel)}}">Kembali</a>
