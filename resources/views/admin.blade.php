...
<div class="m-stack__item m-brand  m-brand--skin-dark ">
	<div class="m-stack m-stack--ver m-stack--general">
		<div class="m-stack__item m-stack__item--middle m-brand__logo">
			...
			<img alt="" src="assets/demo/default/media/img/logo/logo_default_dark.png"/> <!-- Logo APP -->
			</a>  
		</div>
			...
			<div class="m-dropdown__header m--align-center" style="background: url(assets/app/media/img/misc/user_profile_bg.jpg); background-size: cover;">
				<div class="m-card-user m-card-user--skin-dark">
					...
					<div class="m-card-user__details">
						<span class="m-card-user__name m--font-weight-500">Iqbalul Hidayat</span>
						<a href="" class="m-card-user__email m--font-weight-300 m-link">iqbalul.hidayat@gmail.com</a>
					</div>
				</div>
			</div>
	...
	<div 
		...
		<li class="m-menu__section ">
            ...
            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" >
            	<a  href="javascript:;" class="m-menu__link m-menu__toggle" title="Pengguna">
            		...
            		<ul class="m-menu__subnav">
            			...
            			<li class="m-menu__item " aria-haspopup="true" >
            				<a  href="components/icons/fontawesome5.html" class="m-menu__link " >
            					...
            					<span class="m-menu__link-text">Data Kelas</span>
            				</a>
            			</li>
            			<li class="m-menu__item " aria-haspopup="true" >
            				<a  href="components/icons/lineawesome.html" class="m-menu__link " >
            					...
            					<span class="m-menu__link-text">Data Mapel</span>
            				</a>
            			</li>
            			<li class="m-menu__item " aria-haspopup="true" >
            				<a  href="components/icons/socicons.html" class="m-menu__link " >
            					...
            					<span class="m-menu__link-text">Data Soal</span>
            				</a>
            			</li>
            		</ul>
            	</div>
            ...
            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" >
            	<a  href="/admin" class="m-menu__link m-menu__toggle" title="Nilai">
