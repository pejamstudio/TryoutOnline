                        ...
                        <td class="text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{route('pengguna.siswa.detail')}}" class="dropdown-item"><i class="ti-info mr-3"></i>Detail</a>
                                    <a href="{{route('pengguna.siswa.edit')}}" class="dropdown-item"><i class="ti-pencil mr-3"></i>Edit</a>
